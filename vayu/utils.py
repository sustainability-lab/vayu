  ...
  country_pollutants = {
      'Canada' : {
          'AQHI' : {
            ...
            'color_scale' : np.array(['#00ccff', '#0099cc', '#006699', '#ffff00','#ffcc00','#ff9933', 
                                       '#ff6666', '#ff0000', '#cc0000', '#990000', '#660000'])
          }
      },
      'Hong Kong' : {
          'AQHI' : {
            ...
            'color_scale' : np.array(['#008000', '#FFA500', '#FF0000', '#A52A2A', '#000000']) 
          }       
      },      
      'Mainland China' : {
          'AQI' : {
            ...
            'color_scale' : np.array(['#00FF00', '#FFFF00','#FF9900','#FF0000','#540099','#800000'])
          }          
      },      
      'South Korea' : {
          'CAI' : {
            ...
            'color_scale' : np.array(['#0000FF', '#005500','#FFFF00','#FF9900','#FF0000','#990000'])
          }          
      },      
      'United Kingdom' : {
          'APB' : {
            ...
            'color_scale' : np.array(['#CCFFCC', '#66FF66','#00FF00','#99FF00', '#FFFF00', '#FFCC00',
                                      '#FF6600', '#FF3300', '#FF0000', '#FF0066'])
          }          
      },
      'India' : {
          'AQI' : {
            ...
            'color_scale' : np.array(['#00CC00', '#66CC00', '#FFFF00', '#FF9900', '#FF0000', '#A52A2A'])
          },
          'so2': {      
      ...
      'Europe' : {
          'CAQI': {
            ...
            'color_scale' : np.array(['#79BC6A', '#BBCF4C', '#EEC20B', '#F29305', '#E8416F'])
          }
      },
      'USA' : {
          'AQI': {
          ...
          'color_scale' : np.array(['#00E400', '#FFFF00', '#FF7E00', '#FF0000', '#99004C', '#7E0023'])
          }
      }
  }

  def pollutant_legend(country, pollutant):
    colormap = Legend.cm.LinearColormap(colors=Legend.country_pollutants[country][pollutant]['color_scale'], 
                                        vmin=0, vmax=Legend.country_pollutants[country][pollutant]['bin_edges'][-1], 
